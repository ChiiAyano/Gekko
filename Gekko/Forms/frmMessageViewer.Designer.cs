namespace Gekko.Forms
{
	partial class frmMessageViewer
	{
		...
		private void InitializeComponent()
		{
			...
			this.messageViewerBox = new Gekko.Forms.Components.WebBrowserEx();
			...
			this.messageViewerBox.NewWindow2 += new Gekko.Forms.Components.WebBrowserNewWindow2EventHandler(this.messageViewerBox_NewWindow2);
			...
			// topMostButton
			// 
			this.topMostButton.Image = global::Gekko.icons.lightbulb;
			...
			this.browserViewButton.Image = global::Gekko.icons.world_go;
			...
			// checkSpamButton
			// 
			this.checkSpamButton.Image = global::Gekko.icons.bug;
			...
			this.invisibleViewerButton.Image = global::Gekko.icons.application_side_expand;
			...
			this.windowOpacityMenu.Image = global::Gekko.icons.contrast_high;
		...
		private Gekko.Forms.Components.WebBrowserEx messageViewerBox;
