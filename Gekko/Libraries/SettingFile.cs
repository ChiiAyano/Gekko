...
namespace Gekko.Libraries
{
	...
	public class ConfigData
	{
		...
		// 表示設定
		private string c_messageListFontName = Properties.Resources.SettingsMessageListDefaultFont;
		...
		private bool c_disableNotificationAnimation = false;
		// その他設定
		...
		/// <summary>
		/// メールチェック中に通知領域アイコンをアニメーションしないかどうか
		/// </summary>
		public bool DisableNotifyAnimation
		{
			get { return c_disableNotificationAnimation; }
			set { c_disableNotificationAnimation = value; }
		}
